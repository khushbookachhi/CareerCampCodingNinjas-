...
//  public static LinkedListNode<Integer> reverseHeadBest(LinkedListNode<Integer> head){     //O(n)   
//     	if(head==null || head.next==null) {
//     		return head;
//     	}
//     	LinkedListNode<Integer> reverseHead=reverseHeadBest(head.next);
...
// LinkedListNode<Integer> temp=head, newHead=null,newTail=null, tail=null,list=head,hold=null;
...
//     		temp.next=null;
//     		if(newHead==null) {
//     			newHead=reverseHeadBest(list);
//     			newTail=newHead;
//     		}else {
//     			newTail.next=reverseHeadBest(list);
//     		}
